...
if selected == "Logistic Regression":
    ...
    if Logistic_Regression == 'Step 6: Prediction Results':
        ...
        if st.button('Code'):
            ...
            st.write("""plt.show()""")
        st.image("https://raw.githubusercontent.com/Wolverine2029/PDS_Project/main/logisticregressionCMatrix.PNG")
        if st.button("Explanation"):
            st.write("""
...
if selected == "KNN":
    ...
    if KNN == 'Step 6: Prediction Results':
        ...
        if st.button('Code'):
            ...
            st.write("""plt.show()""")
        st.image("https://raw.githubusercontent.com/Wolverine2029/PDS_Project/main/KNNCM.png")
        if st.button("Explanation"):
            st.write("""
...
if selected == "Random Forest":
    ...
    if Random_Forest == 'Step 6: Prediction Results':
        ...
        st.image("https://raw.githubusercontent.com/Wolverine2029/PDS_Project/main/RandomForestCM.PNG")
        if st.button("Explanation  "):
            st.write("""
                    The top left value represents the true positive classifications.  This means you predicted positive and it's 
                    true.  In the case of our dataset, you predicted that a tumor is malignant and it actually is. 
    ...
    if Naive_Bayes == 'Step 6: Prediction Results':
        ...
        if st.button('Code'):
            ...
            st.write("""
                    plt.show()
                    """)
        st.image("https://github.com/Wolverine2029/PDS_Project/blob/main/NaiveBayesCM.PNG?raw=true")
        if st.button("Explanation"):
            st.write("""
                    The top left value represents the true positive classifications.  This means you predicted positive and it's 
                    true.  In the case of our dataset, you predicted that a tumor is malignant and it actually is. 
...
if selected == "Home":
    ...
    st.markdown("""
                ...
                between the dependent and independent variable.  You may ask "Wait, This is a regression! I thought we were doing classification!" and you would be correct.  
                Logistic Regression can be made into a classification problem by deciding cutoff values that we use to then sort the observations into different classes!
                Logistic Regression is a classification method that best works when classifying observations into two different classes.
                """)
    st.markdown("""
                """)
    st.markdown("# KNN")
